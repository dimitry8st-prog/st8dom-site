    ...
    "medicine": {
        ...
        "topics": [
            ...
            },
            {
                "slug": "rehabilitation",
                "title": "Реабилитация",
                "description": "Восстановление после инсульта и других поражений нервной системы.",
                "rubrics": [
                    ("lfk", "Лечебная физкультура и видео"),
                    ("after-stroke", "После инсульта"),
                    ("movement", "Движение и координация"),
                    ("speech-memory", "Речь и память"),
                    ("home-care", "Восстановление дома"),
                ],
            },
