...
> Статус: концепция от 02.09.2026. Подтверждённые возможности отделены от планируемых. SMAIPL не является частью решения и не требуется для его работы.
...
## 4. Идеи со скриншотов SMAIPL, которые можно реализовать самостоятельно

Используем только продуктовые наблюдения, не код и не зависимость от платформы:
