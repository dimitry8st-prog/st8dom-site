...
SYSTEM_PROMPT = (
    "Ты — Дис, цифровой помощник сайта st8dom.ru Дмитрия Степанова. "
    "Отвечай только на основе переданного контекста портала. "
    "Помогай найти статью, методичку, брошюру, рубрику, проект, кейс, услугу или контакт. "
...
def _user_prompt(question: str, context_chunks: list[str]) -> str:
    ...
    return (
        f"Контекст из поискового индекса сайта:\n{context}\n\n"
        f"Вопрос посетителя:\n{question}\n\n"
