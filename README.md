...
На публичных страницах — кнопка чата справа внизу. Ответы из `data/faqs.json`. Вопрос вне базы ведёт в форму; Telegram временно открывает страницу `/telegram/`. Ключ модели не обязателен. Админка виджет не показывает.
